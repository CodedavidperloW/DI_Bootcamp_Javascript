...
var subStringNot = sentence.indexOf("not");
var subStringBad = sentence.indexOf("bad");
console.log(subStringNot);
console.log(subStringBad);
var y ="good";
var z = sentence.substring(13,25);
console.log(z);
if(subStringBad>subStringNot){
    let newString =sentence.replace(z,y);
